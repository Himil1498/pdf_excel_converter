        ...
        <div className="absolute right-0 mt-2 w-96 bg-white rounded-lg shadow-xl dark:shadow-gray-900/50 border border-gray-200 dark:border-gray-700 z-50 max-h-[600px] overflow-hidden flex flex-col">
          ...
          <div className="p-4 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center bg-gray-50 dark:bg-gray-900">
            <h3 className="text-lg font-bold text-gray-900 dark:text-white">
              Notifications
              {unreadCount > 0 && (
                <span className="ml-2 text-sm text-gray-600 dark:text-gray-300">({unreadCount} unread)</span>
              )}
            </h3>
            <button
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        {/* Alert Type Badge */}
                        <span className="inline-block px-2 py-1 text-xs font-medium bg-white rounded mb-2">
                        ...
                        <div className="flex gap-2 mt-2">
                          ...
                          <button
                            ...
                            className="flex items-center gap-1 px-3 py-1 text-xs bg-gray-200 text-gray-700 rounded hover:bg-gray-300 transition-colors"
                          >
                            <X className="w-3 h-3" />
                            Dismiss
                          </button>
