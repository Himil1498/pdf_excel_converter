...
const HelpPage = () => {
  ...
  const FlowBox = ({ feature, children, className = '' }) => {
    ...
    const colorClasses = {
      blue: 'bg-blue-100 dark:bg-blue-900/30 border-blue-500 hover:bg-blue-200 dark:hover:bg-blue-900/50',
      green: 'bg-green-100 dark:bg-green-900/30 border-green-500 hover:bg-green-200 dark:hover:bg-green-900/50',
      purple: 'bg-purple-100 dark:bg-purple-900/30 border-purple-500 hover:bg-purple-200 dark:hover:bg-purple-900/50',
      yellow: 'bg-yellow-100 dark:bg-yellow-900/30 border-yellow-500 hover:bg-yellow-200 dark:hover:bg-yellow-900/50',
      red: 'bg-red-100 dark:bg-red-900/30 border-red-500 hover:bg-red-200 dark:hover:bg-red-900/50',
      orange: 'bg-orange-100 dark:bg-orange-900/30 border-orange-500 hover:bg-orange-200 dark:hover:bg-orange-900/50',
    };
          ...
          <div className="space-y-6">
            <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mb-4">
              <p className="text-sm text-blue-900 dark:text-blue-100 flex items-center gap-2">
                ...
                <span className="font-medium">Click any box below to see detailed instructions</span>
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-lg">
              ...
              <div className="flex flex-col items-center gap-4 max-w-4xl mx-auto">
                ...
                <div className="grid grid-cols-3 gap-4 w-full">
                  <FlowBox feature="analytics">
                    Analytics
                  </FlowBox>
                  <FlowBox feature="search">
                    Search
                  </FlowBox>
                  <FlowBox feature="compare">
                    Compare
                  </FlowBox>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 w-full max-w-2xl">
                  <FlowBox feature="validation">
                    Validate Data
                  </FlowBox>
                  <FlowBox feature="corrections">
                    Fix Errors
                  </FlowBox>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 w-full max-w-2xl">
                  <FlowBox feature="scheduler">
                    Automate Jobs
                  </FlowBox>
                  <FlowBox feature="templates">
                    Manage Templates
                  </FlowBox>
                </div>
                ...
                {/* Final Export */}
                <Arrow direction="down" />
                <div className="bg-green-100 dark:bg-green-900/30 border-2 border-green-500 rounded-lg p-6 w-full max-w-md text-center">
                  <Download className="w-8 h-8 mx-auto mb-2 text-green-600 dark:text-green-400" />
                  <h3 className="font-bold text-lg text-gray-900 dark:text-white">Export & Done!</h3>
                  <p className="text-sm text-gray-600 dark:text-gray-400">Download Excel, CSV, or JSON</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div className="border-l-4 border-blue-500 pl-4">
                ...
                <p className="text-gray-700 dark:text-gray-300 mb-2">
                  Navigate to the Upload page and select your invoice PDFs. You can upload 1-1000 files at once.
                </p>
                <ul className="list-disc list-inside text-sm text-gray-600 dark:text-gray-400 space-y-1">
                  <li>Choose the correct vendor type (Vodafone, Tata, Airtel, etc.)</li>
              ...
              <div className="border-l-4 border-green-500 pl-4">
                ...
                <p className="text-gray-700 dark:text-gray-300 mb-2">
                  Go to the Batches page to see all your processing batches and their status.
                </p>
                <ul className="list-disc list-inside text-sm text-gray-600 dark:text-gray-400 space-y-1">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-blue-800 dark:text-blue-200">
                    If you're processing invoices from a new vendor, create a custom template on the Templates page first.
                    This ensures accurate data extraction tailored to that vendor's invoice format.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4">
                  ...
                  <ul className="space-y-2 text-sm text-green-800 dark:text-green-200">
                    <li>• Always select the correct vendor type before uploading</li>
                    <li>• Process PDFs in batches of 100-200 for optimal performance</li>
                    <li>• Use AI extraction for complex or non-standard invoices</li>
                    <li>• Regular extraction (regex) is faster for standard formats</li>
                  </ul>
                </div>
                ...
                <div className="bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800 rounded-lg p-4">
                  ...
                  <ul className="space-y-2 text-sm text-purple-800 dark:text-purple-200">
                    ...
                    <li>• Vendor breakdown helps identify major cost contributors</li>
                ...
                <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                  ...
                  <ul className="space-y-2 text-sm text-blue-800 dark:text-blue-200">
                    <li>• Save frequently used search queries for quick access</li>
                    <li>• Use amount range to find high-value invoices</li>
                    <li>• Circuit ID search helps track specific connections</li>
                    <li>• Export search results directly from the results page</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 rounded-lg p-4">
                  ...
                  <ul className="space-y-2 text-sm text-orange-800 dark:text-orange-200">
                    ...
                    <li>• Enable auto-export in job config for hands-free processing</li>
                ...
                <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4">
                  ...
                  <ul className="space-y-2 text-sm text-red-800 dark:text-red-200">
                    ...
                    <li>• Look for cost changes &gt;10% (automatically highlighted)</li>
            ...
            <div className="space-y-4">
              <details className="group border border-gray-200 dark:border-gray-700 rounded-lg">
                ...
                <div className="p-4 pt-0 text-gray-700 dark:text-gray-300 text-sm">
                  You can upload up to 1000 PDF files in a single batch. For optimal performance, we recommend batches of 100-200 files.
                </div>
              </details>
              ...
              <details className="group border border-gray-200 dark:border-gray-700 rounded-lg">
                ...
                <div className="p-4 pt-0 text-gray-700 dark:text-gray-300 text-sm">
                  Failed PDFs are marked in red on the Batch Details page. You can retry them individually by clicking the "Retry" button. Check the error message to understand why processing failed.
                </div>
              </details>
              ...
              <details className="group border border-gray-200 dark:border-gray-700 rounded-lg">
                ...
                <div className="p-4 pt-0 text-gray-700 dark:text-gray-300 text-sm">
                  <strong>Regular extraction</strong> (regex-based) is faster (1-2s per PDF) and works well for standard invoice formats. <strong>AI extraction</strong> (GPT-4) is slower (3-5s per PDF) but more accurate for complex or non-standard formats. For known vendors with templates, use regular extraction.
                </div>
              </details>
              ...
              <details className="group border border-gray-200 dark:border-gray-700 rounded-lg">
                ...
                <div className="p-4 pt-0 text-gray-700 dark:text-gray-300 text-sm">
                  Go to Templates page → Click "Create New Template" → Enter vendor name → Define field mappings using regex patterns in JSON format → Test with sample PDF → Save. Refer to existing templates as examples.
                </div>
              </details>
              ...
              <details className="group border border-gray-200 dark:border-gray-700 rounded-lg">
                ...
                <div className="p-4 pt-0 text-gray-700 dark:text-gray-300 text-sm">
                  Yes! Use the Corrections page to manually edit any field. All changes are logged with timestamp and reason. You can also fix errors directly from the Validation page.
                </div>
              </details>
              ...
              <details className="group border border-gray-200 dark:border-gray-700 rounded-lg">
                ...
                <div className="p-4 pt-0 text-gray-700 dark:text-gray-300 text-sm">
                  We support Excel (.xlsx), CSV, and JSON formats. Excel includes full formatting and all columns. CSV is best for importing into other systems. JSON is for API/integration use cases.
                </div>
              </details>
              ...
              <details className="group border border-gray-200 dark:border-gray-700 rounded-lg">
                ...
                <div className="p-4 pt-0 text-gray-700 dark:text-gray-300 text-sm">
                  Go to Scheduler page → Click "Create New Job" → Select job type (Batch Processing) → Set schedule (daily, weekly, or custom cron) → Configure folder and vendor → Enable auto-export if needed → Save. The job runs automatically.
                </div>
              </details>
              ...
              <details className="group border border-gray-200 dark:border-gray-700 rounded-lg">
                ...
                <div className="p-4 pt-0 text-gray-700 dark:text-gray-300 text-sm">
                  Currently supported: Vodafone Idea, Tata Teleservices, Bharti Airtel, Indus Towers, Ascend Telecom, Sify Technologies, and BSNL. You can also create custom templates for other vendors.
                </div>
              </details>
            </div>
